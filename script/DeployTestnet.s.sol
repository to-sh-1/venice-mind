...
import {MockVVV} from "../test/MockVVV.sol";
import {ERC1967Proxy} from "@openzeppelin/contracts/proxy/ERC1967/ERC1967Proxy.sol";

/**
 * @title DeployTestnet Script
 * @dev Script to deploy the Venice Mind Burn system with a mock VVV token
 * @notice Intended for testnets and local testing only
 */
